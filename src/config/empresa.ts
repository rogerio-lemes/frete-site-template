// ============================================================
//  ARQUIVO CENTRAL DE CONFIGURAÇÃO DA EMPRESA
...
// ── Links WhatsApp gerados automaticamente ───────────────────
export const WA_LINK  = `https://wa.me/${EMPRESA.telefoneRaw}?text=${encodeURIComponent(EMPRESA.waMensagemPadrao)}`;
export const WA_BASIC = WA_LINK;
export const WA_CHAT  = WA_LINK;
export const WA_IDEAL = `https://wa.me/${EMPRESA.telefoneRaw}?text=${encodeURIComponent(EMPRESA.waMensagemIdeal)}`;
